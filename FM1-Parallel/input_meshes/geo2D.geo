...
Field[1] = MathEval;
Field[1].F = "0.005 + 0.05*sqrt((x-10.)*(x-10.)+(y-10.)*(y-10.))";
...
Mesh.CharacteristicLengthMin = 0.025;
Mesh.CharacteristicLengthMax = 1.;
//+
Physical Volume("HostRock", 0) = {1, 2, 4, 5};
Physical Volume("Fault",    1) = {3};
...
// }
// //+
// Physical Volume("HostRock", 78) = {1, 3};
// Physical Volume("Fault", 79) = {2};
